...
<div class = "ser" align = left>
            ...
            <input type ="button" onclick="ser11()" value="熱咖啡系列" style="width:200px;height:40px;font-size:20px;"></input><br>
            <input type ="button" onclick="ser12()" value="冰咖啡系列" style="width:200px;height:40px;font-size:20px;"></input><br>
            <input type ="button" onclick="ser13()" value="茶&奶茶系列" style="width:200px;height:40px;font-size:20px;"></input><br>
            <input type ="button" onclick="ser14()" value="湯品果汁&其他系列" style="width:200px;height:40px;font-size:20px;"></input><br>
            

</div>
<div class = "drink" align = center>
<?php
	# 設定資料庫參數
	...
	//	mysqli_query($link, "SET NAMES 'UTF8'"); 
		if($result = mysqli_query($link,$sql))
		{
			...
			while($row=mysqli_fetch_assoc($result))
            {
                ...
                echo "</b><br/>";
                echo "<img widht=150 height=150 src=".$photo.">";
				echo "</b><br/>";
